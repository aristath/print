...
function print_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'print' ),
	) );
 ...
 */
function print_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'print_content_width', 640 );
}
add_action( 'after_setup_theme', 'print_content_width', 0 );
...
function print_scripts() {
	...
	wp_enqueue_script( 'print-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'print-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
